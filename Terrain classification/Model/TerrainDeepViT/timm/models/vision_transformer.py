...
default_cfgs = {
    ...
    'T2t_vit_t_14': _cfg_t2t(),
    'T2t_vit_t_19': _cfg_t2t(),
    'T2t_vit_t_24': _cfg_t2t(),
    'T2t_vit_7': _cfg_t2t(),
    'T2t_vit_10': _cfg_t2t(),
    'T2t_vit_12': _cfg_t2t(),
    'T2t_vit_14': _cfg_t2t(),
    'T2t_vit_19': _cfg_t2t(),
    'T2t_vit_24': _cfg_t2t(),
    'T2t_vit_14_resnext': _cfg_t2t(),
    'T2t_vit_14_wide': _cfg_t2t(),
}
...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, use_original_patch=True):
        super().__init__()
...
def vit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=384, depth=16, num_heads=12, mlp_ratio=3, qkv_bias=True,
