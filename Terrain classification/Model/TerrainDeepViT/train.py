...
from deep_vit.utils.misc import bn_calibration
...
def train_epoch(
    ...
    model_ema=None,
    mixup_fn=None,
    dis_fn=torch.nn.CosineSimilarity(dim=1),
):
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            if (
                "vit_base_patch16_224_share_attn_cos_reg" in args.model
                or args.use_cos_reg_component
            ):
